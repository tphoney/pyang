...
def pyang_plugin_init():
    plugin.register_plugin(Puppet3Plugin())

class Puppet3Plugin(plugin.PyangPlugin):
    ...
    def add_opts(self, optparser):
        optlist = [
            optparse.make_option("--puppet3-help",
                                 dest="puppet3_help",
                                 action="store_true",
                                 help="Print help on puppet3 symbols and exit"),
            optparse.make_option("--puppet3-depth",
                                 type="int",
                                 dest="puppet3_depth",
                                 help="Number of levels to print"),
            optparse.make_option("--puppet3-path",
                                 dest="puppet3_path",
                                 help="Subtree to print"),
            optparse.make_option("--puppet3-print-groupings",
                                 dest="puppet3_print_groupings",
                                 action="store_true",
                                 help="Print groupings"),
            ]
        g = optparser.add_option_group("puppet3 output specific options")
